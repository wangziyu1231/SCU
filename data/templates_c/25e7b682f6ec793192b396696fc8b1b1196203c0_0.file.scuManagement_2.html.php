...
/* Smarty version 3.1.30, created on 2017-10-26 09:08:02
  from "F:\www\SCU\tpls\admin\scuManagement_2.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59f1a5f28a65a8_00047767',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '25e7b682f6ec793192b396696fc8b1b1196203c0' => 
    array (
      0 => 'F:\\www\\SCU\\tpls\\admin\\scuManagement_2.html',
      1 => 1509008699,
      2 => 'file',
    ),
  ),
  'includes' => 
  array (
    'file:admin/scuManagement_2_1.html' => 1,
  ),
),false)) {
function content_59f1a5f28a65a8_00047767 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
>
	<?php echo '<script'; ?>
 src="./img/js/admin/scuManagement_2.js"><?php echo '</script'; ?>
>
	
</head>
<body style="overflow-x: hidden">
					<!--==模块====审核信息=活动注册审核========================-->
			<div class="right" id="activityDiv">
				<div class="nowPosition"><span>你现在的位置：社团相关>年度注册审核</span></div>
				<div class="rightTable">
					<table class="activityTable">
						<tr class="bgk">
							<td style="width: 30%;">社团名称</td>
...
>
								<td style="width: 30%;"><?php echo $_smarty_tpl->tpl_vars['value']->value->sName;?>
</td>
								<td style="width: 10%"><?php echo $_smarty_tpl->tpl_vars['value']->value->nhName;?>
</td>
								...
								<span class="operation" id="yearOperationChange" onclick="check(<?php echo $_smarty_tpl->tpl_vars['value']->value->sNO;?>
)">审核
...
?>
					...
					<?php if ((($tmp = @$_smarty_tpl->tpl_vars['arr']->value)===null||$tmp==='' ? null : $tmp) == null) {?><span style="position:relative;display:inline-block;left:40%">没有查询结果</span><?php }?>
					
					<div class="cutPages">
						<a href="admin.php?controller=sManage&method=yearRegGetpage&page=1" class="firstAndLast"><span>首页</span></a>
...
?>
						<?php }?>
						<a href="admin.php?controller=sManage&method=yearRegGetpage&page=<?php echo $_smarty_tpl->tpl_vars['pp']->value;?>
...
$_smarty_tpl->tpl_vars['i']->first = $_smarty_tpl->tpl_vars['i']->iteration == 1;$_smarty_tpl->tpl_vars['i']->last = $_smarty_tpl->tpl_vars['i']->iteration == $_smarty_tpl->tpl_vars['i']->total;?>
							<a href="admin.php?controller=sManage&method=yearRegGetpage&page=<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
...
?>
						...
						<a href="admin.php?controller=sManage&method=yearRegGetpage&page=<?php echo $_smarty_tpl->tpl_vars['pp']->value;?>
" class="fbgk"><span>>></span></a>
						<a href="admin.php?controller=sManage&method=yearRegGetpage&page=<?php echo $_smarty_tpl->tpl_vars['page']->value;?>
" class="firstAndLast"><span>尾页</span></a>
    ...
    <?php $_smarty_tpl->_subTemplateRender("file:admin/scuManagement_2_1.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
