...
/* Smarty version 3.1.30, created on 2017-10-26 09:10:08
  from "F:\www\SCU\tpls\admin\backstageManagement_1.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59f1a670dfdec8_34201652',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '406edc65c2f13f702fe0823903d2483cf0f045a7' => 
    array (
      0 => 'F:\\www\\SCU\\tpls\\admin\\backstageManagement_1.html',
      1 => 1509008699,
      2 => 'file',
    ),
  ),
...
function content_59f1a670dfdec8_34201652 (Smarty_Internal_Template $_smarty_tpl) {
?>
<html>
<head>
	<meta charset="utf-8">
			...
			<div class="searchIframe"  >
				<form action="admin.php?controller=socmem&method=search" method="post">
							<div class="department">
								...
								<span class="sIpt2">性别</span><input type="text" class="ipt" name="sex">
								<!--  此处系别与专业重复了
								<span class="sIpt2">专业</span><input type="text" class="ipt" name="sm">
								-->
								<br/>
								<span class="sIpt">手机</span><input type="text" class="ipt" name="tel">
								<span class="sIpt2">微信</span><input type="text" class="ipt" name="wechat">
							</div><input type="submit" name="" class="iframeBtn" value="查询">
							<!-- <div></div> -->
						</form>
			</div>
